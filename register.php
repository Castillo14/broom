              ...
              <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="user">
                ...
                <div class="form-group row"  <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>>
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control form-control-user" name="username" placeholder="Username" value="<?php echo $username; ?>">
                ...
                <div class="form-group row" <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>>
                  ...
                  <div class="col-sm-6" <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>>
                    <input type="password" class="form-control form-control-user" name="confirm_password" placeholder="Confirm Password" value="<?php echo $confirm_password; ?>">
                  ...
                  <br><br><br>
                   ...
                   <div class="form-group">
                      ...
                      <input type="reset" class="btn btn-danger btn-user btn-block"value="Reset">
                  </div>
